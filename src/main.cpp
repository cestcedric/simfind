...
int main(int argc, char* argv[]) {
	...
	else
	{
		...
		std::string initialState = "E:/Dokumente/Schule/tum/Informatik/6/Bachelor-Arbeit/Code/SimFind/files/initalState_0.sto";
		...
		*/
		...
		States t(from, to, 3);
		std::cout << "rank : " << t.getRank(to) << std::endl;
		std::vector<double> a = t.getAngles(to);
